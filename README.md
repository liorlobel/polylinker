...
> crates and 153,782 lines of Rust, 92,252 of it dependency-free (141 `.rs`
> files under `crates/` and `bins/`), with 1,893 `#[test]` functions and a
> 68-step gate (`Step` invocations in `tools/ci.ps1`) that cross-checks the
