...
> crates and 147,578 lines of Rust, 89,281 of it dependency-free (139 `.rs`
> files under `crates/` and `bins/`), with 1,821 `#[test]` functions and a
