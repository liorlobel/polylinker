...
> crates and 144,698 lines of Rust, 89,082 of it dependency-free (138 `.rs`
> files under `crates/` and `bins/`), with 1,795 `#[test]` functions and a
> 67-step gate (`Step` invocations in `tools/ci.ps1`) that cross-checks the
