...
/// One ORF as Python sees it: start, end, strand, length, start codon, complete.
///
...
type PyOrf = (u64, u64, String, usize, String, bool);

/// Open reading frames, as `(start, end, strand, aa_len, start_codon, complete)`.
///
/// Coordinates are 1-based inclusive on the plus strand. `end < start` means
/// the ORF crosses the origin of a circular molecule.
#[pyfunction]
