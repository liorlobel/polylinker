...
sed -i 's/version = "0.8.0"/version = "0.8.1"/g' Cargo.toml
...
grep -c 'version = "0.8.1"' Cargo.toml   # must print 17
grep -c 'version = "0.8.0"' Cargo.toml   # must print 0
...
git tag -a v0.8.1 -m "Polylinker 0.8.1"
