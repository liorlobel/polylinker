...
sed -i 's/version = "0.13.6"/version = "0.13.7"/g' Cargo.toml
...
grep -c 'version = "0.13.7"' Cargo.toml   # must print 17
grep -c 'version = "0.13.6"' Cargo.toml   # must print 0
...
git tag -a v0.13.7 -m "Polylinker 0.13.7"
