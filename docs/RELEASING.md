...
sed -i 's/version = "0.10.1"/version = "0.10.2"/g' Cargo.toml
...
grep -c 'version = "0.10.2"' Cargo.toml   # must print 17
grep -c 'version = "0.10.1"' Cargo.toml   # must print 0
...
git tag -a v0.10.2 -m "Polylinker 0.10.2"
