...
sed -i 's/version = "0.11.2"/version = "0.12.0"/g' Cargo.toml
...
grep -c 'version = "0.12.0"' Cargo.toml   # must print 17
grep -c 'version = "0.11.2"' Cargo.toml   # must print 0
...
git tag -a v0.12.0 -m "Polylinker 0.12.0"
