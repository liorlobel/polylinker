...
sed -i 's/version = "0.11.1"/version = "0.11.2"/g' Cargo.toml
...
grep -c 'version = "0.11.2"' Cargo.toml   # must print 17
grep -c 'version = "0.11.1"' Cargo.toml   # must print 0
...
git tag -a v0.11.2 -m "Polylinker 0.11.2"
