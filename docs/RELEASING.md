...
sed -i 's/version = "0.13.4"/version = "0.13.5"/g' Cargo.toml
...
grep -c 'version = "0.13.5"' Cargo.toml   # must print 17
grep -c 'version = "0.13.4"' Cargo.toml   # must print 0
...
git tag -a v0.13.5 -m "Polylinker 0.13.5"
